 ...
 *
 */
class solak_Service extends Widget_Base {

	public function get_name() {
		return 'solakservice';
	}
	public function get_title() {
		return __( 'Services', 'solak' );
	}
	...
	protected function register_controls() {
		...
		solak_general_fields($this, 'arrow_id', 'Arrow ID or Class', 'TEXT', 'serviceSlide', ['1']);
	...
	protected function render() {
		...
		if( $settings['layout_style'] == '1' ){
			echo '<div class="slider-area">';
                echo '<div class="swiper th-slider has-shadow" id="'.esc_attr($settings['arrow_id']).'" data-slider-options=\'{"loop":true,"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"2"},"1200":{"slidesPerView":"3"},"1400":{"slidesPerView":"4"}}}\'>';
			...
			echo '<div class="slider-area">';
				echo '<div class="swiper th-slider has-shadow" id="serviceSlide2" data-slider-options=\'{"loop":true,"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"2"},"1200":{"slidesPerView":"3"},"1400":{"slidesPerView":"4"}}}\'>';
					echo '<div class="swiper-wrapper">';
				...
				echo '<div class="service-arrow">';
					echo '<div class="icon-box">';
						echo '<button data-slider-prev="#serviceSlide2" class="slider-arrow default"><i class="far fa-arrow-left"></i></button>';
						echo '<button data-slider-next="#serviceSlide2" class="slider-arrow default"><i class="far fa-arrow-right"></i></button>';
					echo '</div>';
				echo '</div>';
			echo '</div>';
			...
			echo '<div class="slider-area">';
				echo '<div class="swiper th-slider has-shadow" id="serviceSlide3" data-slider-options=\'{"loop":true,"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"2"},"1200":{"slidesPerView":"3"},"1400":{"slidesPerView":"4"}}}\'>';
					echo '<div class="swiper-wrapper">';
						foreach( $settings['service_list2'] as $data ){
							echo '<div class="swiper-slide">';
			...
			echo '<div class="slider-area slider-drag-wrap">';
				echo '<div class="swiper th-slider has-shadow" id="serviceSlide4" data-slider-options=\'{"loop":true,"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"1"},"992":{"slidesPerView":"2"},"1400":{"slidesPerView":"3"}}}\'>';
					echo '<div class="swiper-wrapper">';
						foreach( $settings['service_list2'] as $data ){
							echo '<div class="swiper-slide">';
