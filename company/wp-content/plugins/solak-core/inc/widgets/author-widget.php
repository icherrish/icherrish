...
class solak_author_widget extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct(
                ...
                esc_html__( 'Solak :: Author Widget', 'solak' ),

                // Widget description
                array(
                    'customize_selective_refresh'   => true,
                    'description'                   => esc_html__( 'Add Author Widget', 'solak' ),
                    'classname'                     => 'no-class',
                )
            );
        ...
        public function form( $instance ) {
        	...
        	?>
            <p>
                <label for="<?php echo $this->get_field_id( 'author_img_url' ); ?>"><?php _e( 'Image URL:' ,'solak'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'about_name' ); ?>"><?php _e( 'Author Name:' ,'solak'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'about_bio' ); ?>"><?php _e( 'Author Bio:' ,'solak'); ?></label>
    ...
    } // Class solak_author_widget ends here


    // Register and load the widget
    function solak_author_load_widget() {
        register_widget( 'solak_author_widget' );
    }
    add_action( 'widgets_init', 'solak_author_load_widget' );