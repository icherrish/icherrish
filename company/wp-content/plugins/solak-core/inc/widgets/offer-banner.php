...
class solak_offer_banner_widget extends WP_Widget {

        function __construct() {

            parent::__construct(
                // Base ID of your widget
                'solak_offer_banner_widget',

                // Widget name will appear in UI
                esc_html__( 'Solak :: Offer Banner Widget', 'solak' ),

                // Widget description
                array(
                    'customize_selective_refresh'   => true,
                    'description'                   => esc_html__( 'Add Offer Banner Widget', 'solak' ),
        ...
        public function form( $instance ) {
        	...
        	?>
            <p>
                <label for="<?php echo $this->get_field_id( 'banner_img_url' ); ?>"><?php _e( 'Image URL:' ,'solak'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'banner_img_url2' ); ?>"><?php _e( 'Logo URL:' ,'solak'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'banner_title' ); ?>"><?php _e( 'Banner Title:' ,'solak'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'banner_desc' ); ?>"><?php _e( 'Banner Description:' ,'solak'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'banner_phone' ); ?>"><?php _e( 'Phone Number:' ,'solak'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'button_text' ); ?>"><?php _e( 'Button Text:' ,'solak'); ?></label>
                <input class="widefat" id="<?php echo $this->get_field_id( 'button_text' ); ?>" name="<?php echo $this->get_field_name( 'button_text' ); ?>" type="text" value="<?php echo esc_attr( $button_text ); ?>" />
            </p>
            <p>
                <label for="<?php echo $this->get_field_id( 'button_url' ); ?>"><?php _e( 'Button URL:' ,'solak'); ?></label>
    ...
    } // Class solak_offer_banner_widget ends here


    // Register and load the widget
    function solak_offer_banner_load_widget() {
        register_widget( 'solak_offer_banner_widget' );
    }
    add_action( 'widgets_init', 'solak_offer_banner_load_widget' );