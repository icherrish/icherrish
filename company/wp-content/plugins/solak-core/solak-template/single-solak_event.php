    ...
    <div class="container">
        <div class="event-details space-bottom">
            <?php while( have_posts( ) ) :
                the_post();
                 $time       = solak_meta( 'event_time' );
                 $gallery       = solak_meta( 'event_gallery' );
                 $event_info       = solak_meta( 'event_details' );
                 $iframe   = solak_meta( 'event_iframe' );
                 $link1   = solak_meta( 'event_calendar_link' );
                 $link2   = solak_meta( 'event_calendar_link2' );
            ?>
            ...
            <div class="row mb-35 gy-4">
                ...
                <div class="col-lg-5 align-self-center">
                    <div class="btn-group justify-content-lg-end">
                        <a target="_blank" href="<?php echo esc_attr($link1) ?>" class="as-btn wave-btn"><?php echo esc_html__('Save On Calendar', 'solak'); ?></a>
                        <a target="_blank" href="<?php echo esc_attr($link2) ?>" class="as-btn wave-btn"><?php echo esc_html__('Ical Export', 'solak'); ?></a>
                    </div>
                </div>
            </div>
            ...
            <div class="row gy-30">
                <div class="col-lg-7">
                    <h3><?php echo esc_html__('Event Details', 'solak'); ?></h3>
