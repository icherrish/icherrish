        ...
        <div class="container space-extra-bottom">
            <div class="row gy-4">
                <?php 
                    ...
                    $start_date       = solak_meta( 'event_schedule_start' );
                    $end_date       = solak_meta( 'event_schedule_end' );
                    $time       = solak_meta( 'event_time' );
                    $location   = solak_meta( 'event_laction' );
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="event-card">
                        ...
                        <div class="thumb">
                            <?php the_post_thumbnail( 'solak_356X276' ); ?>
                        </div>
                        <?php endif; ?>
                        <div class="details">
                            ...
                            <a class="read-more-btn" href="<?php echo esc_url( get_permalink() ); ?>"><?php echo esc_html__('More Details', 'solak'); ?> <i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
