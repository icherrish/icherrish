    ...
    <div class="sidenav-menu">
        <div class="nav accordion pb-5" id="accordionSidenav">
            ...
            <div class="collapse" id="collapseHotels" data-bs-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav">
            <a class="nav-link" href="<?php echo e(route('admin.modules.data','hotels')); ?>">
                        All Hotels
            </a>
            <a class="nav-link" href="<?php echo e(route('admin.modules.data.add','hotels')); ?>">
                Add New Hotel
            </a>
            <a class="nav-link" href="<?php echo e(route('admin.modules.data','hotel-types')); ?>">
                Hotel Types
            </a>
            <a class="nav-link" href="<?php echo e(route('admin.modules.data','hotel-star')); ?>">
                        Hotel Star Ratings
            </a>
            <a class="nav-link" href="<?php echo e(route('admin.modules.data','destinations')); ?>">
                Destinations
            </a>
            <a class="nav-link" href="<?php echo e(url('admin/hotel-bookings')); ?>">
                        Hotel Bookings
                    </a>
                </nav>
            </div>
            ...
            <div class="collapse" id="collapseFlights" data-bs-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav">
                    <a class="nav-link" href="<?php echo e(route('admin.modules.data','airline-companies')); ?>">
                        Airline Companies
                    </a>
                    <a class="nav-link" href="<?php echo e(url('admin/flight-orders')); ?>">
                        Flight Bookings
                    </a>
                    <a class="nav-link" href="<?php echo e(url('admin/airports')); ?>">
                        List Airports
                    </a>
                    <a class="nav-link" href="<?php echo e(url('admin/airports/create')); ?>">
                        Add New Airport
                    </a>
                </nav>
            </div>           
            ...
            <div class="collapse" id="collapseTours" data-bs-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav">
                    <a class="nav-link" href="<?php echo e(route('admin.modules.data','tour')); ?>">
                        Tours List
                    </a>
                    <a class="nav-link" href="<?php echo e(route('admin.modules.data.add','tour')); ?>">
                        Add New Tour
                    </a>
                    <a class="nav-link" href="<?php echo e(route('admin.modules.data','trip-type')); ?>">
                        Trip Types
                    </a>
                    <a class="nav-link" href="<?php echo e(route('admin.modules.data','trip-transport')); ?>">
                        Trip Transport Types
                    </a>
                    <a class="nav-link" href="<?php echo e(route('admin.tour-bookings.index')); ?>">
                        Tour Bookings
                    </a>
                </nav>
            </div>
            ...
            <div class="collapse" id="collapseBlog" data-bs-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav">
            <a class="nav-link" href="<?php echo e(route('admin.modules.data','blogs')); ?>">
                Blog List
            </a>
            <a class="nav-link" href="<?php echo e(route('admin.modules.data.add','blogs')); ?>">
                Add New Post
            </a>
            <a class="nav-link" href="<?php echo e(route('admin.modules.data','blog-categories')); ?>">
                Blog Categories
                    </a>
                </nav>
            </div>
            ...
            <div class="collapse" id="collapseContent" data-bs-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav">
                    <a class="nav-link" href="<?php echo e(route('admin.modules.data','cms-pages')); ?>">
                        CMS Pages
                    </a>
                    <a class="nav-link" href="<?php echo e(route('admin.modules.data.add','cms-pages')); ?>">
                        Add New Page
                    </a>
                    <a class="nav-link" href="<?php echo e(route('admin.modules.data','services')); ?>">
                        Services
                    </a>
                    <a class="nav-link" href="<?php echo e(route('admin.modules.data.add','services')); ?>">
                        Add New Service
                    </a>
                </nav>
            </div>
            ...
            <div class="collapse" id="collapseTeam" data-bs-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav">
                    <a class="nav-link" href="<?php echo e(route('admin.modules.data','customer-support-team')); ?>">
                        Team List
            </a>
            <a class="nav-link" href="<?php echo e(route('admin.modules.data.add','customer-support-team')); ?>">
                Add New Team
            </a>
                </nav>
            </div>
            ...
            <div class="collapse" id="collapseCountry" data-bs-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav">
                    ...
                    <a class="nav-link" href="<?php echo e(route('admin.countries.create')); ?>">
                        Add New Country
                    </a>
                </nav>
            </div>
            ...
            <div class="collapse" id="collapseState" data-bs-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav">                   
                    <a class="nav-link" href="<?php echo e(route('admin.states.index')); ?>">
                        States/Provinces
                    </a>
                    <a class="nav-link" href="<?php echo e(route('admin.states.create')); ?>">
                        Add New State
                    </a>
                </nav>
            </div>
            ...
            <div class="collapse" id="collapseCity" data-bs-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav">
                    ...
                    <a class="nav-link" href="<?php echo e(route('admin.cities.create')); ?>">
                        Add New City
                    </a>
                </nav>
            </div>
            ...
            <div class="collapse" id="collapseMenus" data-bs-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav">
                    ...
                    <a class="nav-link" href="<?php echo e(route('admin.menus.translations')); ?>">
                        Menu Translations
                    </a>
                </nav>
            </div>
            <a class="nav-link" href="<?php echo e(route('admin.modules.data','testimonials')); ?>">
                <div class="nav-link-icon"><i class="fa-solid fa-star"></i></div>
                Testimonials
            </a>
            <a class="nav-link" href="<?php echo e(route('admin.contact-us-messages')); ?>">
            ...
            <a class="nav-link" href="<?php echo e(route('admin.content.translations.index')); ?>">
                <div class="nav-link-icon"><i class="fa-solid fa-language"></i></div>
                Content Translations
            </a>
            <!-- Widget Translations -->
            <a class="nav-link" href="<?php echo e(route('admin.widget.translations.index')); ?>">
          ...
          ?>
          <!-- __BLOCK__ --><?php if(null!==($w_pages)): ?>
                    <a class="nav-link" href="<?php echo e(route('admin.currency-settings.index')); ?>">
                        <div class="nav-link-icon"><i class="fa-solid fa-money-bill-wave"></i></div>
                        Currency Settings
                    </a>
                    <!-- __BLOCK__ --><?php $__currentLoopData = $w_pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w_p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a class="nav-link" href="<?php echo e(route('admin.widgets_data',$w_p->slug)); ?>">
                    <div class="nav-link-icon"><i class="fa-solid fa-gear"></i></div>
                        <?php echo e($w_p->title); ?>
...
<?php /**PATH /home/icherrish.com/public_html/easytrips/resources/views/livewire/admin/common/sidebar.blade.php ENDPATH**/ ?>