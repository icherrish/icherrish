...
<body>
    <div class="container">
        <div class="header">
            <img src="<?php echo e(asset('images/'.widget(1)->extra_image_1)); ?>" alt="Logo" style="max-width: 200px; margin-bottom: 20px;">
        ...
        <div class="footer">
            ...
            <p style="color: #555; margin-top: 40px;">
                ...
                <a href="<?php echo e(url('/')); ?>" target="_blank" style="color: #015b9c;"><?php echo e(url('/')); ?></a>
            </p>
        </div>
    </div>
</body>
</html>
<?php /**PATH /home/icherrish.com/public_html/easytrips/resources/views/emails/verification-code.blade.php ENDPATH**/ ?>