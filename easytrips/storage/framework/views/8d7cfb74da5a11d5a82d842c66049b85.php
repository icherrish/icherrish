                        ...
                        <div class="card-body text-white p-4">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="flex-grow-1">
                                    ...
                                    <h2 class="card-title text-white fw-bold mb-1" style="font-size: 1.6rem;"><?php echo e($currencySymbol); ?> <?php echo e(number_format(array_sum($totalRevenue), 2)); ?></h2>
                        ...
                        <div class="card-body text-white p-4">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="flex-grow-1">
                                    ...
                                    <h2 class="card-title text-white fw-bold mb-1" style="font-size: 2.5rem;"><?php echo e(number_format($total_users)); ?></h2>
                        ...
                        <div class="card-body text-white p-4">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="flex-grow-1">
                                    ...
                                    <h2 class="card-title text-white fw-bold mb-1" style="font-size: 2.5rem;"><?php echo e(number_format($total_hotels)); ?></h2>
                        ...
                        <div class="card-body text-white p-4">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="flex-grow-1">
                                    ...
                                    <h2 class="card-title text-white fw-bold mb-1" style="font-size: 2.5rem;"><?php echo e(number_format($total_tours)); ?></h2>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg mb-6">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="<?php echo e(route('admin.flight-orders')); ?>" class="text-indigo-600 hover:text-indigo-900 text-sm font-medium">
                            View All →
                        </a>
                    </div>
...
<?php $__empty_1 = true; $__currentLoopData = $flight_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    ...
    <tr>
        ...
        <td>
            <a href="<?php echo e(route('admin.flight-order', $order->id)); ?>" class="btn btn-sm btn-primary">View</a>
        </td>
    </tr>
...
<?php endif; ?>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg mb-6">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="<?php echo e(route('admin.tour-bookings.index')); ?>" class="text-indigo-600 hover:text-indigo-900 text-sm font-medium">
                            View All →
                        </a>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="table table-hover table-striped table-bordered myjobtable">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php $__empty_1 = true; $__currentLoopData = $tour_bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <span class="font-mono text-xs"><?php echo e($booking->booking_reference); ?></span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <div>
                                                <div class="font-medium"><?php echo e($booking->user->name ?? 'N/A'); ?></div>
                                                <div class="text-gray-500 text-xs"><?php echo e($booking->user->email ?? 'N/A'); ?></div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <div class="max-w-xs truncate" title="<?php echo e($booking->tour->title ?? 'N/A'); ?>">
                                                <?php echo e($booking->tour->title ?? 'N/A'); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <?php if($booking->departure_date): ?>
                                                <div>
                                                    <div class="font-medium"><?php echo e(date('d M Y', strtotime($booking->departure_date))); ?></div>
                                                    <div class="text-gray-500 text-xs"><?php echo e(date('D', strtotime($booking->departure_date))); ?></div>
                                                </div>
                                            <?php else: ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <div class="font-medium"><?php echo e($currencySymbol); ?> <?php echo e(number_format($booking->total_amount)); ?></div>
                                        </td>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="<?php echo e(route('admin.hotel-bookings')); ?>" class="text-indigo-600 hover:text-indigo-900 text-sm font-medium">
                            View All →
                        </a>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="table table-hover table-striped table-bordered myjobtable">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php $__currentLoopData = $hotel_bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <?php echo e($booking->travelling_from); ?>

                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <?php echo e(date('d M Y l', strtotime($booking->check_in))); ?>

                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <div class="font-medium"><?php echo e($currencySymbol); ?> <?php echo e(number_format($booking->price, 2)); ?></div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <?php echo e($booking->payment_via); ?>

                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="<?php echo e(route('admin.hotel-booking', $booking->id)); ?>" 
                                               class="btn btn-sm btn-primary">View Details</a>
                                        </td>
                                    </tr>
    ...
    <script>
        ...
        let revenueChart = new Chart(revenueCtx, {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: 'Hotels',
                        data: <?php echo json_encode($hotelRevenue, 15, 512) ?>,
                    ...
                    {
                        label: 'Flights',
                        data: <?php echo json_encode($flightRevenue, 15, 512) ?>,
                    ...
                    {
                        label: 'Tours',
                        data: <?php echo json_encode($tourRevenue, 15, 512) ?>,
                    ...
                    y: {
                        ...
                        ticks: {
                            callback: function(value) {
                                return '<?php echo e($currencySymbol); ?>' + value.toLocaleString();
                            }
                        }
                    }
                }
        ...
        new Chart(dailyCtx, {
            type: 'bar',
            data: {
                labels: <?php echo json_encode($dailyDates, 15, 512) ?>,
                datasets: [
                    {
                        label: 'Hotels',
                        data: <?php echo json_encode($dailyHotelBookings, 15, 512) ?>,
                    ...
                    {
                        label: 'Flights',
                        data: <?php echo json_encode($dailyFlightBookings, 15, 512) ?>,
                    ...
                    {
                        label: 'Tours',
                        data: <?php echo json_encode($dailyTourBookings, 15, 512) ?>,
        ...
        new Chart(revenuePieCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [
                        <?php echo e(array_sum($hotelRevenue)); ?>,
                        <?php echo e(array_sum($flightRevenue)); ?>,
                        <?php echo e(array_sum($tourRevenue)); ?>
                    ...
                    tooltip: {
                        callbacks: {
                            label: function(context) {
                                ...
                                return context.label + ': ' + '<?php echo e($currencySymbol); ?>' + context.parsed.toLocaleString() + ' (' + percentage + '%)';
                            }
                        }
                    }
                }
...
<?php endif; ?> 
<?php /**PATH /home/icherrish.com/public_html/easytrips/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>