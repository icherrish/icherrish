...
*
*/
define('APP_BASE_URL', 'https://icherrish.com/edge/');
...
*/
define('APP_ENC_KEY', 'f5d56ec26831fc1eaf801a3fc5a196fc');
 ...
 */
define('APP_DB_USERNAME', 'iche_edge');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'o7aJ3gUyXtUS7Gz');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'iche_edge');
